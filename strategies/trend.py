...
def determine_new_trend(symbol, entry_side, num_total_grids, active_grid_pos) -> bool:
    ...
    micro_tf_vwap = float(micro_tf_triggers_dict['vwap'])
    macro_tf_vwap = float(macro_tf_triggers_dict['vwap'])
    ...
    print(f'micro_tf_range: {micro_tf_range}, current value: {micro_tf_vwap}')

    print(f'macro_tf: {macro_tf}')
    print(f'micro_tf_range: {macro_tf_range}, current value: {macro_tf_vwap}\n')
